...
public interface LiveDao {
     ...
     * @return
     */
    List<Map<String,Object>> getLiveListPageBySName(Map<String, Object> params);
     ...
     * @return
     */
    int getLiveListSumBySName(Map<String, Object> params);
     ...
     * @return
     */
    Map<String,Object> getLivePlayDataById(@Param("liveId") int liveId);
     ...
     * @return
     */
    Map<String,Object> getLivePlayDataByCode(String streamCode);
}
