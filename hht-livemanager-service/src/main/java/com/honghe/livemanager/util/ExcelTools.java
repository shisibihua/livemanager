...
public class ExcelTools {
    ...
    private String exportExcelFile(String[] headers, List<Map<String,Object>> list, String filepath,
        ...
        for (int i = 0; i < headers.length; i++) {
            ...
            cellStyle.setBorderLeft(BorderStyle.THIN); // 左侧边框
            cellStyle.setLeftBorderColor(IndexedColors.BLACK.getIndex()); // 左侧边框颜色

            cellStyle.setBorderTop(BorderStyle.THIN); // 顶部边框
            cellStyle.setTopBorderColor(IndexedColors.BLACK.getIndex()); // 顶部边框颜色

            cellStyle.setBorderRight(BorderStyle.THIN); // 右侧边框
            cellStyle.setRightBorderColor(IndexedColors.BLACK.getIndex()); // 右侧边框颜色
        ...
        dataStyle.setBorderBottom(BorderStyle.THIN); // 底部边框
        dataStyle.setBottomBorderColor(IndexedColors.BLACK.getIndex()); // 底部边框颜色

        dataStyle.setBorderLeft(BorderStyle.THIN); // 左侧边框
        dataStyle.setLeftBorderColor(IndexedColors.BLACK.getIndex()); // 左侧边框颜色

        dataStyle.setBorderTop(BorderStyle.THIN); // 顶部边框
        dataStyle.setTopBorderColor(IndexedColors.BLACK.getIndex()); // 顶部边框颜色

        dataStyle.setBorderRight(BorderStyle.THIN); // 右侧边框
        dataStyle.setRightBorderColor(IndexedColors.BLACK.getIndex()); // 右侧边框颜色
     ...
     * @param sheet
     */
    private void setSheetAutoWidth(HSSFSheet sheet){
...
//        }
    ...
    private void setSheetAutoWidthStatistic(HSSFSheet sheet){
        sheet.setColumnWidth(0,20*256);
        sheet.setColumnWidth(1,15*256);
    ...
    private void writeLiveExcel(Map<String,Object> map,HSSFRow dataRow,HSSFCellStyle dataStyle){
        ...
        //推流地址
        Map<String,String> streamUrlMap=getStreamUrl(map.get("streamCode").toString(),map.get("endTime").toString());
        ...
        videoFrameRateCell.setCellValue(map.get("videoFrameRate")==null?"":map.get("videoFrameRate").toString());
        videoFrameRateCell.setCellStyle(dataStyle);
        //推流码率
        HSSFCell bitRateCell = dataRow.createCell(11);
        bitRateCell.setCellValue(map.get("bitRate")==null?"":map.get("bitRate").toString());
        bitRateCell.setCellStyle(dataStyle);
        //宽带
        HSSFCell bandWidthCell = dataRow.createCell(12);
        bandWidthCell.setCellValue(map.get("bandWidth")==null?"":map.get("bandWidth").toString());
        bandWidthCell.setCellStyle(dataStyle);
        //流量
        HSSFCell trafficValueCell = dataRow.createCell(13);
        trafficValueCell.setCellValue(map.get("trafficValue")==null?"":map.get("trafficValue").toString());
        trafficValueCell.setCellStyle(dataStyle);
        //观看人数
        HSSFCell viewersNumberCell = dataRow.createCell(14);
        viewersNumberCell.setCellValue(map.get("viewersNumber")==null?"":map.get("viewersNumber").toString());
     ...
     * @return
     */
    private Map<String,String> getStreamUrl(String streamCode,String endTime){
