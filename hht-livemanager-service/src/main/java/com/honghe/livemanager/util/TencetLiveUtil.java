...
public class TencetLiveUtil implements LiveUtil {
    ...
    public static String CLOUD_TENCENT_SECRETID="";
    public static String CLOUD_TENCENT_SECRETKEY="";
...
//    private static String CLOUD_TENCENT_PLAYDOMAIN="liveplay.myqcloud.com";
    public static String CLOUD_TENCENT_PUSHURL="livepush.hitecloud.cn";
    public static String CLOUD_TENCENT_PLAYURL="play.hitecloud.cn";

    static{
        String pushUrl= ConfigUtil.getInstance().getPropertyValue("cloud.tencent.push.url");
        String playUrl= ConfigUtil.getInstance().getPropertyValue("cloud.tencent.play.url");
        if(!StringUtil.isEmpty(pushUrl)){
            CLOUD_TENCENT_PUSHURL=pushUrl;
        }
        if(!StringUtil.isEmpty(playUrl)){
            CLOUD_TENCENT_PLAYURL=playUrl;
        }
    }
    ...
    public Map<String,String> getLiveStreamUrl(String streamCode,String time) {
        ...
        if(ParamUtil.isEmpty(streamCode)) {
            streamCode = CLOUD_TENCENT_BIZID + "_" + UUIDUtil.getUUID();
        }
...
//        pushStr.append("rtmp://").append(bizid).append(".").append(CLOUD_TENCENT_PUSHURL);
        pushStr.append("rtmp://").append(CLOUD_TENCENT_PUSHURL).append("/live/");
...
//        playStr.append(bizid).append(".").append(CLOUD_TENCENT_PLAYURL).append(streamCode);
        playStr.append(CLOUD_TENCENT_PLAYURL).append("/live/").append(streamCode);
