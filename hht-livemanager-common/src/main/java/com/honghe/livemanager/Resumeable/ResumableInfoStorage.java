...
public class ResumableInfoStorage {
    ...
    public synchronized ResumableInfo get(int resumableChunkSize, long resumableTotalSize,
                             ...
                             String resumableRelativePath, String resumableFilePath,String resumableFileMd5String,int resumableTotalChunks) {
        ...
        if (info == null) {
            ...
            info.resumableFileMd5String = resumableFileMd5String;
            info.resumableTotalChunks   = resumableTotalChunks;
